<template>
 <div>
  ...
  <el-form-item label="选择网点">
    <el-select v-model="soucon.offid" placeholder="请选择活动区域">
     ...
     <el-table-column label="操作" width="280">
      <template slot-scope="scope">
        ...
        <el-button
          size="mini"
          type="primary"
          @click="handleJin(scope.$index, scope.row)">禁用</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 分页 -->
  ...
  <!-- 删除框弹出 -->
        <el-dialog title="提示" :visible.sync="jinVisible" width="300px" center>
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="jinYong" >确 定</el-button>
            </span>
        </el-dialog>
<!-- 删除框弹出 -->
 </div>
  ...
  export default {
    data() {
      return {
        ...
        row:{},
        tableData: [
          {id:1,nick:"小dd红",account:"222aaaaaa",avatar:"11111111111",type:"1",createtime:"素履之往"},
          {id:2,nick:"小add红",account:"aaa333aaa",avatar:"11111111111",type:"1",createtime:"素履之往"},
